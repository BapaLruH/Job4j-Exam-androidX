...
public class AppContentProvider extends ContentProvider {
    ...
    static {
        ...
        mUriMatcher.addURI(AppContentProviderData.CONTENT_PROVIDER_AUTHORITY_NAME, AppContentProviderHelper.TableNames.LOCATION_TABLE_NAME, AppContentProviderData.ID_LOCATION_TABLE);
    }
    ...
    public String getType(@NonNull Uri uri) {
        String type = null;
        if (mUriMatcher.match(uri) == AppContentProviderData.ID_LOCATION_TABLE) {
            type = AppContentProviderHelper.TableNames.LOCATION_TABLE_NAME;
        }
        return type;
    }
